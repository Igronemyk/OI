...
int main() {
    ...
    while(true) {
        ...
        switch(opt) {
            case 1: {
                int x = read<int>() ^ lastAns,y = read<int>() ^ lastAns,A = read<int>() ^ lastAns;
                keys[0] = x;
                keys[1] = y;
                tree.insert(keys,A);
                break;
            ...
            case 2: {
                int x1 = read<int>() ^ lastAns,y1 = read<int>() ^ lastAns,x2 = read<int>() ^ lastAns,y2 = read<int>() ^ lastAns;
                lastAns = tree.getSumValue(x1,y1,x2,y2);
                printf("%lld\n",lastAns);
                break;
            }
            case 3: {
